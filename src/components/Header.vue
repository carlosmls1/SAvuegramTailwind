      ...
      <div class="relative flex justify-between xl:grid xl:grid-cols-12 lg:gap-8">
        ...
        <div class="hidden lg:flex lg:items-center lg:justify-end xl:col-span-4">
          <a href="#" class="ml-5 flex-shrink-0 bg-white rounded-full p-1 text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-rose-500">
            ...
            <BellIcon size="1.5x" class="h-6 w-6" />
          </a>
          ...
          <div class="flex-shrink-0 relative ml-5">
            <t-dropdown
                :classes="{
  dropdown: 'origin-top-right absolute z-10 right-0 mt-2 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 py-1',
  ...
  leaveToClass: 'transform opacity-0 scale-95',
      ...
      isShown
              ...
              <div
                ...
                <router-link
                    @blur="blurHandler"
                    to="/settings" href="#" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Your Profile</router-link>
                <router-link
                    @blur="blurHandler"
                    to="/settings" href="#" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Settings</router-link>
                <a @click="logout()" href="#" class="block py-2 px-4 text-sm text-red-500 hover:bg-gray-100" role="menuitem">Sign out</a>
              </div>
            </t-dropdown>
          </div>
        </div>
...
<script>
import { BellIcon, ArrowCircleUpIcon } from '@vue-hero-icons/outline'
